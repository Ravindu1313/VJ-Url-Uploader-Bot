...
class Config(object):
    ...
    TECH_VJ_SESSION_NAME = "rgUper"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("MONGO_STR", "")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "")) # your log channel id and make bot admin in log channel with full right 
    
    # if you want force subscribe then give your channel id below else leave blank
    tech_vj_update_channel = environ.get('UPDATES_CHANNEL', '') # your update channel id and make bot admin in update channel with full right
